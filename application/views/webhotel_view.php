		...
		<tr>
			<td align="center" valign="top">			
				<table width="500" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
					<tr>
						<td class="td" style="width:500px; min-width:500px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
							<repeater>								
								<layout label='Section 1'>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ebebeb">
										<tr style="background-image: url(images/bg_1.jpg); background-size: cover;">
											<td class="p30-15-0" style="padding:1px;    background-color: #ccc;" bgcolor="">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
											   		<ins class="bookingaff" data-aid="1909494" data-target_aid="1909494" data-prod="nsb" data-width="350" data-height="380" data-lang="en" data-currency="AED">
