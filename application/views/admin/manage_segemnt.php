       ...
       <div class="static-content">
            <div class="page-content">
                <ol class="breadcrumb">
                     ...
                     <li><a href="<?php echo base_url(); ?>admin/manage_segment">manage segment</a></li>
							 ...
							 <tr class="odd gradeX">
								...
								<td><?php echo $seg['start_range'] . '-'.$seg['end_range'] ; ?></td>
								    ...
								    <td class="center">
									  ...
									  <a href="<?php echo base_url(); ?>admin/edit_segment/<?php echo $seg['seg_id']; ?>">edit</a>
